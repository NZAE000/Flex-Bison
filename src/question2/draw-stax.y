...
term: NUMBER
 ...
 | AP exp CP { $$ = $2;              }
 ;
func: ROTATION AP term CP         { rotar($3);     }
 | ROTATION AP term COMA term CP  { rotar($3, $5); }
 | MOVE AP term CP                { mover($3);     }
 | MOVE AP term COMA term CP      { mover($3, $5); }
...
void mover(float distance)
{
    ...
    mover(pointTarget.x, pointTarget.y);
}
